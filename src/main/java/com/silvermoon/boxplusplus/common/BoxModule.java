...
public class BoxModule {
    ...
    public static int[] transMachinesToModule(ItemStack machine) {
        return switch (machine.getUnlocalizedName().substring(17)) {
            ...
            case "industrialrockcrusher.controller.tier.single","industrialfluidheater.controller.tier.single" -> new int[]{5,0};
            ...
            case "industrialwashplant.controller.tier.single","industrialsifter.controller.tier.single",
                "industrialcentrifuge.controller.tier.single","industrialelectrolyzer.controller.tier.single","digester" -> new int[]{7,0};
            ...
            case "moleculartransformer.controller.tier.single" -> new int[]{0,1};
            ...
            case "multimachine.plasmaforge","multimachine.nanoforge" ->new int[]{8,1};
