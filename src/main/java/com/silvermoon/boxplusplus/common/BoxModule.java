...
public class BoxModule {
    ...
    static {
        Atomic_Manipulation_Claw.moduleStructure = new String[][] { { "   ", " C ", "   " }, { " C ", " Z ", " C " },
            { " C ", " C ", " C " } };
        Facility_3826.moduleStructure = new String[][] { { "   ", " C ", "   " }, { "   ", "CYC", "   " },
            { "   ", "CCC", "   " } };
        Sinopec_Group.moduleStructure = new String[][] { { "   ", " C ", "   " }, { " C ", " X ", " C " },
            { " C ", " C ", " C " } };
        Residential_Gas_Water_Heater.moduleStructure = new String[][] { { "   ", " C ", "   " },
            { "   ", "CWC", "   " }, { "   ", "CCC", "   " } };
        AMD_Wafer_Fabrication_Plant.moduleStructure = new String[][] { { "   ", " E ", "   " }, { " E ", " E ", " E " },
            { " E ", " V ", " E " }, { " E ", "EEE", " E " } };
        Liquid_Level_Regulator.moduleStructure = new String[][] { { "   ", " E ", "   " }, { "   ", "EEE", "   " },
            { "   ", "EUE", "   " }, { "   ", "EEE", "   " } };
        Solid_State_Reshaper.moduleStructure = new String[][] { { "   ", " E ", "   " }, { " E ", " E ", " E " },
            { " E ", " T ", " E " }, { " E ", " E ", " E " } };
        Residential_Flush_Toilet_with_Built_in_Pump.moduleStructure = new String[][] { { "   ", " E ", "   " },
            { "   ", "EEE", "   " }, { "   ", "ESE", "   " }, { "   ", "EEE", "   " } };
        Extreme_Temperature_Difference_Generation_Tower.moduleStructure = new String[][] {
            { "   ", "   ", " F ", "   ", "   " }, { "   ", " F ", " R ", " F ", "   " },
            { " F ", " F ", " F ", " F ", " F " }, { " F ", " F ", " F ", " F ", " F " } };
        Superstructure_Assembly_Plant.moduleStructure = new String[][] { { "   ", "   ", "  F  ", "   ", "   " },
            { "   ", "   ", " FQF ", "   ", "   " }, { "   ", "   ", "FFFFF", "   ", "   " },
            { "   ", "   ", "FFFFF", "   ", "   " } };
        Phase_Parallel_Matrix.moduleStructure = new String[][] { { "   ", "   ", " F ", "   ", "   " },
            { "   ", " F ", " P ", " F ", "   " }, { " F ", " F ", " F ", " F ", " F " },
            { " F ", " F ", " F ", " F ", " F " } };
        Arrayed_and_Maneuverable_Hyperbeam_Receiver_Redirector.moduleStructure = new String[][] {
            { "     ", "     ", "  G  ", "     ", "     " }, { "     ", "     ", "  G  ", "     ", "     " },
            { "     ", "  G  ", " GNG ", "  G  ", "     " }, { "  G  ", " GGG ", "GGGGG", " GGG ", "  G  " } };
        CAERULA_ARBOR.moduleStructure = new String[][] { { "  G  ", " GGG ", "GGGGG", " GGG ", "  G  " },
            { "     ", "  G  ", " GMG ", "  G  ", "     " }, { "     ", "     ", "  G  ", "     ", "     " },
            { "     ", "     ", "  G  ", "     ", "     " } };
    }
